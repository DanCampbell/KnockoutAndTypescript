...
class ContributeViewModel {
    ...
    constructor(UserSelected: any, Parent: string, Contributor: string) {
        this.Parent = Parent;
      ...
      //  console.log(this.children());
        ...
        if (currentChild != null) {
          //  let p1 = new Points();
            ...
            p1.ContributorId = this.Contributor;
            p1.Approved = false;
    ...
    getGood = (root: any, behavior: KnockoutObservableArray<Behaviour>) => {
    var promise =
        $.ajax({
    ...
    getBad = (root: any, behavior: KnockoutObservableArray<Behaviour>) => {
        var promise =
            $.ajax({
